...
public class StatusController {
	...
	public ResponseEntity<String> getStatus() throws JsonProcessingException {
		log.info("college status start serverPort {}, applicationName {}, profile {}, message {}",serverPort,applicationName,profile,stausMessage);
		...
		log.info("college status  {} ",jsonString);
